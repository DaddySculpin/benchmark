...
var _Toolbar = _interopRequireWildcard(__webpack_require__(353));
...
const MultipleSelectContext = /*#__PURE__*/(0, _react.createContext)({
  selected: [],
  eliminated: [],
...
function MultipleSelectChoice({
  ...
  const {
    ...
    onEliminate,
    isGroupDisabled
  } = useMultipleSelectContext(); // We generate a unique ID to each choice for this
  // SingleSelect instance. This ID is used to generate the
  // labels and also to assign a default choice value.

  const [choiceId, setChoiceId] = (0, _react.useState)(0);
  (0, _react.useEffect)(() => {
    setChoiceId(getChoiceId()); // eslint-disable-next-line react-hooks/exhaustive-deps
  }, []); // If no value is defined, set it useding the choice ID.

  value = value || (0, _helpers.numberToLetter)(choiceId);
  const label = (0, _helpers.getNumberLabel)(choiceId, labelType);
...
MultipleSelect.propTypes = {
  ...
  // display
  labelType: _propTypes.default.oneOf(['letters', 'numbers', 'none']),
  // data
...
exports.getNumberLabel = getNumberLabel;

function numberToLetter(number = 0) {
  if (number === 0) {
    return ' ';
  }
...
function getNumberLabel(number, labelType = 'none') {
  switch (labelType) {
    case 'none':
      return '';
...
var _Paragraph = _interopRequireDefault(__webpack_require__(344));
...
const SingleSelectContext = /*#__PURE__*/(0, _react.createContext)({
  selected: undefined,
  eliminated: [],
  isGroupDisabled: false,
  labelType: 'letters',
...
function SingleSelectChoice({
  ...
  const {
    ...
    getChoiceId,
    onEliminate
  } = useSingleSelectContext(); // We generate a unique ID to each choice for this
  // SingleSelect instance. This ID is used to generate the
  // labels and also to assign a default choice value.
  //
...
var _ScrollButton = _interopRequireDefault(__webpack_require__(349));
...
var _Toolbar = _interopRequireDefault(__webpack_require__(354));
...
const ZonesContext = /*#__PURE__*/(0, _react.createContext)({
  selected: [],
  onClear: () => {},
  onChange: () => {}
});
...
function Choice({
  ...
  return /*#__PURE__*/_react.default.createElement(_Base.Flex, _extends({}, props, {
    ...
    flexShrink: "0",
    alignItems: "center"
  }, label && /*#__PURE__*/_react.default.createElement(_Base.Box, {
    pr: "2",
    width: "26px",
    sx: {
    ...
    fontWeight: "semibold"
  }, label)), /*#__PURE__*/_react.default.createElement(InputControl, {
    checked: isSelected,
    disabled: isDisabled,
    size: "24px",
    label: label,
...
var _Modal = _interopRequireDefault(__webpack_require__(342));
...
var _SingleSelect = _interopRequireWildcard(__webpack_require__(345));
...
var _Slider = _interopRequireDefault(__webpack_require__(346));
...
var _Switch = _interopRequireDefault(__webpack_require__(347));
...
var _TTS = _interopRequireDefault(__webpack_require__(351));
...
var _TextInput = _interopRequireDefault(__webpack_require__(352));
...
var _Zones = _interopRequireWildcard(__webpack_require__(355));
...
var map = {
	"./components/Alert/Alert.stories.js": 356,
...
var _Grid = _interopRequireDefault(__webpack_require__(357));
...
function Basic() {
  ...
  return /*#__PURE__*/_react.default.createElement(_MultipleSelect.default, {
    ...
    maxChoices: 2
  }, /*#__PURE__*/_react.default.createElement(_MultipleSelect.MultipleSelectChoice, null, "Option A"), /*#__PURE__*/_react.default.createElement(_MultipleSelect.MultipleSelectChoice, null, "Option B"), /*#__PURE__*/_react.default.createElement(_MultipleSelect.MultipleSelectChoice, null, "Option C"));
}
...
function OptionDisabled() {
  ...
  return /*#__PURE__*/_react.default.createElement(_MultipleSelect.default, {
    ...
    isDisabled: true
  }, "Option A"), /*#__PURE__*/_react.default.createElement(_MultipleSelect.MultipleSelectChoice, null, "Option B"), /*#__PURE__*/_react.default.createElement(_MultipleSelect.MultipleSelectChoice, null, "Option C"));
}
...
function LongLabels() {
  ...
  return /*#__PURE__*/_react.default.createElement(_Base.Box, {
    ...
    eliminated: eliminated,
    maxChoices: 2
  }, /*#__PURE__*/_react.default.createElement(_MultipleSelect.MultipleSelectChoice, null, "This is a really long label to test how well the text wraps"), /*#__PURE__*/_react.default.createElement(_MultipleSelect.MultipleSelectChoice, null, "It is in a really small container"), /*#__PURE__*/_react.default.createElement(_MultipleSelect.MultipleSelectChoice, null, "Small option")));
}
...
function Basic() {
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_SingleSelect.default, null, /*#__PURE__*/_react.default.createElement(_SingleSelect.SingleSelectChoice, null, "Option A"), /*#__PURE__*/_react.default.createElement(_SingleSelect.SingleSelectChoice, null, "Option B"), /*#__PURE__*/_react.default.createElement(_SingleSelect.SingleSelectChoice, null, "Option C")));
}
...
function OptionDisabled() {
  ...
  return /*#__PURE__*/_react.default.createElement(_SingleSelect.default, {
    ...
    selected: selected,
    eliminated: eliminated
  }, /*#__PURE__*/_react.default.createElement(_SingleSelect.SingleSelectChoice, null, "Option A"), /*#__PURE__*/_react.default.createElement(_SingleSelect.SingleSelectChoice, {
    isDisabled: true
  }, "Option B"), /*#__PURE__*/_react.default.createElement(_SingleSelect.SingleSelectChoice, null, "Option C"));
}
...
function Disabled() {
  ...
  return /*#__PURE__*/_react.default.createElement(_SingleSelect.default, {
    ...
    eliminated: eliminated,
    isDisabled: true
  }, /*#__PURE__*/_react.default.createElement(_SingleSelect.SingleSelectChoice, null, "Option A"), /*#__PURE__*/_react.default.createElement(_SingleSelect.SingleSelectChoice, null, "Option B"), /*#__PURE__*/_react.default.createElement(_SingleSelect.SingleSelectChoice, null, "Option C"));
}
...
function LongLabels() {
  ...
  return /*#__PURE__*/_react.default.createElement(_Base.Box, {
    ...
    selected: selected,
    eliminated: eliminated
  }, /*#__PURE__*/_react.default.createElement(_SingleSelect.SingleSelectChoice, null, "This is a really long label to test how well the text wraps"), /*#__PURE__*/_react.default.createElement(_SingleSelect.SingleSelectChoice, null, "It is in a really small container"), /*#__PURE__*/_react.default.createElement(_SingleSelect.SingleSelectChoice, null, "Small option")));
}
...
var _addonKnobs = __webpack_require__(358);
...
var _Alert = __webpack_require__(356);
...
//# sourceMappingURL=main.ae7f3a582b5956054935.bundle.js.map